 ...
 * [2. 구현 과정](#2-구현-과정)
    ...
    * [2.2. UI 구현](#22-ui-구현)
    * [2.3. 기능 구현](#23-기능-구현)
 * [3. 문제 해결(Troubleshooting)](#3-문제-해결troubleshooting)
    * [3.1. CanvasView의 선이 매끄럽게 이어지지 않는 문제](#31-canvasview의-선이-매끄럽게-이어지지-않는-문제)
       * [3.1.1. 문제 내용](#311-문제-내용)
       * [3.1.2. 문제 원인](#312-문제-원인)
       * [3.1.3. 해결 과정](#313-해결-과정)
         * [3.1.3.1. lines 프로퍼티 타입 변경](#3131-lines-프로퍼티-타입-변경)
         * [3.1.3.2. line이 추가되는 로직 변경](#3132-line이-추가되는-로직-변경)
         * [3.1.3.3. draw 메서드 로직 변경](#3133-draw-메서드-로직-변경)
    * [3.2. 이미지 분류에 실패했을 경우에 대한 예외처리 문제](#32-이미지-분류에-실패했을-경우에-대한-예외처리-문제)
       * [3.2.1. 문제 내용](#321-문제-내용)
       * [3.2.2. 해결 과정](#322-해결-과정)
         * [3.2.2.1 UIAlertController로 에러메세지 표시하는 방법](#3221-uialertcontroller로-에러메세지-표시하는-방법)
         * [3.2.2.2 기존에 있는 UILabel을 이용하여 에러메세지 표시하는 방법](#3222-기존에-있는-uilabel을-이용하여-에러메세지-표시하는-방법)
         * [3.2.2.3 이미지 분류를 3회 시도 후 에러메시지를 표시하는 방법](#3223-이미지-분류를-3회-시도-후-에러메시지를-표시하는-방법)
 * [4. 참고](#4-참고)
